// components/manual_mode/src/manual_mode.cpp
// ═══════════════════════════════════════════════════════════════════════════════
...
// - Direct motor speed control with rate limiting
// - Manual ESC arming/disarming
...
// ═══════════════════════════════════════════════════════════════════════════════
// GLOBAL MANUAL MODE STATE
// ═══════════════════════════════════════════════════════════════════════════════

static manual_mode_status_t g_manual_status = {0};
static manual_mode_session_stats_t g_session_stats = {0};
...
manual_command_t manual_mode_create_command(manual_command_type_t type, 
    ...
    command.type = type;
    command.speed_parameter = speed;
    command.direction_forward = forward;
...
esp_err_t manual_mode_init(void) {
    ...
    memset(&g_manual_status, 0, sizeof(g_manual_status));
