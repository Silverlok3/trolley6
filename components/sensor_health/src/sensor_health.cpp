// components/sensor_health/src/sensor_health.cpp
...
esp_err_t sensor_health_init(MPU_t* mpu_sensor) {
    ...
    memset(&g_sensor_health, 0, sizeof(g_sensor_health));
    
    // Initialize sensor health structure
