// components/hardware_control/src/hardware_control.cpp
// ═══════════════════════════════════════════════════════════════════════════════
// HARDWARE_CONTROL.CPP - LOW-LEVEL HARDWARE ABSTRACTION LAYER
// ═══════════════════════════════════════════════════════════════════════════════
// 
// SINGLE RESPONSIBILITY: Hardware abstraction only
// - ESC PWM control (init, set_duty, arm, disarm)
// - Hall sensor interrupt handling and processing
// - GPIO initialization and pin management
// - Direct motor speed commands and emergency stop
// 
...
static hardware_status_t g_hw_status = {0};
...
// ═══════════════════════════════════════════════════════════════════════════════
// ESC PWM INITIALIZATION AND CONTROL
// ═══════════════════════════════════════════════════════════════════════════════
